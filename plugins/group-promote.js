...
> ₊· ⫏⫏ ㅤ *Usa:* #promote @usuario
> ₊· ⫏⫏ ㅤ *Usa:* Responde al mensaje con #promote
`.trim())
...
> ₊· ⫏⫏ ㅤ Nσ ρυє∂σ нα¢єямє α∂мιη α мι мιѕмα
`.trim())
...
ㅤ    ꒰  ㅤ ❌ ㅤ *αℓуα ѕυв* ㅤ ⫏⫏  ꒱
ㅤ    ⿻ ㅤ ✿ ㅤ єяяσя 木 уα єѕ α∂мιη ㅤ 性

> ₊· ⫏⫏ ㅤ Eℓ υѕυαяισ уα єѕ α∂мιηιѕтяα∂σя
`.trim())
...
handler.desc = 'ᴘʀᴏᴍᴜᴇᴠᴇ ᴀ ᴜɴ ᴜꜱᴜᴀʀɪᴏ ᴀ ᴀᴅᴍɪɴɪꜱᴛʀᴀᴅᴏʀ'
handler.group = true
handler.admin = true
