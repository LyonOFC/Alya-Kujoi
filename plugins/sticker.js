...
const handler = async (m, { conn }) => {
  ...
  if (!/image|video/.test(mime)) {
    return conn.sendMessage(
      m.chat,
      { text: `ㅤ    ꒰  ㅤ ❌ ㅤ *αℓуα ѕυв* ㅤ ⫏⫏  ꒱
ㅤ    ⿻ ㅤ ✿ ㅤ єяяσя 木 υѕσ ㅤ ✿

> ₊· ⫏⫏ ㅤ *Responde a una imagen o video*
> ₊· ⫏⫏ ㅤ *Usa:* #s
...
ㅤ    ꒰  ㅤ ✿ ㅤ *αℓуα ѕυв* ㅤ ⫏⫏ ꒱`},
  ...
  try {
    ...
    await conn.sendMessage(
      m.chat,
      { text: `ㅤ    ꒰  ㅤ ❌ ㅤ *αℓуα ѕυв* ㅤ ⫏⫏  ꒱
ㅤ    ⿻ ㅤ ✿ ㅤ єяяσя 木 ѕтι¢кєя ㅤ ✿

> ₊· ⫏⫏ ㅤ *Error al generar el sticker*
...
handler.desc = 'ᴄᴏɴᴠɪᴇʀᴛᴇ ᴜɴᴀ ɪᴍᴀɢᴇɴ ᴏ ᴠɪᴅᴇᴏ ᴇɴ ꜱᴛɪᴄᴋᴇʀ'
